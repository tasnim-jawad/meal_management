<div class="page-main-header">
    <div class="main-header-left" semilight-bg-color="bg-default-light-colo">
        <div class="logo-wrapper">
            <a href="{{ route('frontEnd.Meal_Booking.Meal_Booking') }}">
            ...
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    <div class="d-flex align-items-center"><img
                        ...
                        <div>
                            <h6 class="m-0 txt-dark f-16"> {{Illuminate\Support\Facades\Auth::user()->name }}<i
                                    class="fa fa-angle-down pull-right ms-2"></i></h6>
                        </div>
                    </div>
                    <ul class="profile-dropdown onhover-show-div p-2">
                        {{-- <li><a href="#"><i class="icon-user"></i> {{Illuminate\Support\Facades\Auth::user()->name }}</a></li> --}}
                        <li>
                            <a class="dropdown-item" href="#" onclick="event.preventDefault();document.getElementById('logOutForm').submit()">

                                <div class="d-flex align-items-center">
                                    {{-- <div class="setting-icon"><i class="bi bi-lock-fill"></i></div> --}}
                                    <div class="setting-icon"><i class="icon-user"></i></div>
